...
- chore(release): bump package version to 0.12.4

## 0.12.3

- fix(chatgpt): clean removed pending exports before selecting batches
- chore(release): bump package version to 0.12.3
